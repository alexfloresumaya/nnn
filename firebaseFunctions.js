...
const addUserDataToFirestore = async (uid, correo, nombre) => {
  try {
    const usersCollection = firestore.collection('usuarios'); // Asegúrate de usar el nombre correcto de tu colección
    ...
    /* const docRef = firestore.collection('usuarios').doc(uid);
